...
namespace TAM.VMS.Web.Areas.VendorRegistration.Controllers
{
    [Area("VendorRegistration")]
    [Authorize]
    [AppAuthorize("App.VendorRegistration")]
    public class VendorRegistrationController : WebController
    {
        ...
        {
            var result = Service<VendorRegistrationService>().Save(user, roles);
        ...
        public IActionResult ResetPasswordUser(ResetPassword user)
        {
            ...
            {
                result = Service<VendorRegistrationService>().ResetPassword(user);
            }
        ...
        {
            var dataUser = Service<VendorRegistrationService>().GetUserByUsername(SessionManager.Current);
            user.Id = dataUser.ID;
            ...
            {
                result = Service<VendorRegistrationService>().ChangePassword(user);
            }
        ...
        {
            Service<VendorRegistrationService>().Delete(id);
            return Ok();
        }
    }
}