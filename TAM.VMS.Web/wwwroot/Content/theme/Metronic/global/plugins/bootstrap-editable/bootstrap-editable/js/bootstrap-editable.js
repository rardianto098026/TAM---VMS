...
(function ($) {
    ...
    Popup.prototype = {
        ...
        */         
        ...
        renderForm: function() {
            ...
            .on({
                ...
                rendered: $.proxy(function(){
                    ...
                    **Note:** Bootstrap popover has own `shown` event that now cannot be separated from x-editable's TAM.CostingSystem
        ...
        @method show()
        @param {boolean} closeAll Whether to close all other editable containers when showing this TAM.CostingSystem Default true.
        **/
        ...
        **/         
        hide: function(reason) {  
            ...
            **Note:** Bootstrap popover has own `hidden` event that now cannot be separated from x-editable's TAM.CostingSystem
            The workaround is to check `arguments.length` that is always `2` for x-editable. 
...
(function ($) {
    ...
    $.extend(DateField.prototype, {
        render: function () {
            ...
            //bootstrap-datepicker is set `bdateicker` to exclude conflict with jQuery UI TAM.CostingSystem (in date.js)        
